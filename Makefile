...
SOURCES = \
	__init__.py \
	area_limit.py area_limit_dialog.py

PLUGINNAME = area_limit

PY_FILES = \
	__init__.py \
	area_limit.py area_limit_dialog.py

UI_FILES = area_limit_dialog_base.ui
...
QGISDIR=C:\Users\jessi\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
